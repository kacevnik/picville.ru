 ...
 */
class WC_Widget_Layered_Nav_Filters_Custom extends WC_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_name        = 'PictureVille: Фильтр по атрибутам';
        parent::__construct();
    }
    ...
    protected function layered_nav_list( $terms, $taxonomy, $query_type ) {
        // List display.
        echo '<div class="woocommerce-widget-layered-nav-list filter__list">';
